...
test.OnePool_C14_ZeroDecay_Zero_c14_fromDelta14C=function(){
   require(RUnit)
   t_start=0
   t_end=2
   tn=100
 ...
 format="Delta14C")
   ...
   Y14[,1]=c01*(0.001*f01 + 1.0)*exp(-t*log(2)/5730)
...
#begin plots 
   lt1=2
   lt2=4
   pdf(file="runit.automatic.OnePool_C14_ZeroDecay_Zero_c14_fromDelta14C.pdf",paper="a4")
