...
test.TwoPool_C14_equalDecay_ZeroInput_c14_fromDelta14C=function(){
   require(RUnit)
   t_start=0
   t_end=2
   tn=100
...
#begin plots 
   lt1=2
   lt2=4
   pdf(file="runit.automatic.TwoPool_C14_equalDecay_ZeroInput_c14_fromDelta14C.pdf",paper="a4")
