...
Yasso07Model<-structure(
    ...
    ### This function creates a model for five pools as described in the Tuomi et al. (2008)
     (t,      ##<< A vector containing the points in time where the solution is sought.
      ks=c(kA=0.66, kW=4.3, kE=0.35, kN=0.22, kH=3.3),	##<< A vector of lenght 5 containing the values of the decomposition rates for each pool.
...
### A Model Object that can be further queried 
    ...
    ex=function(){
      ...
      plotCPool(years,Rt,col=1:5,xlab="years",ylab="Respiration",ylim=c(0,350))
      legend("topright",c("xA","xW","xE","xN","xH"),lty=1,col=1:5,bty="n")
